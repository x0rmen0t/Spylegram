...
from telethon.tl.types import DocumentAttributeFilename, Message, PeerChannel, MessageMediaDocument, Document
...
def test_get_document_name(doc_name, expected):
    message= Message(id=666, peer_id=PeerChannel(channel_id=666666),
            date=datetime.datetime(1999, 5, 1, 22, 26, 29, tzinfo=datetime.timezone.utc),
            message='Some very important message',
            media=MessageMediaDocument(nopremium=False, spoiler=False,
                                       document=Document(id=123,
                                                         access_hash=-123,
                                                         file_reference=b'\x02h\xea\x8dI\x00\x00\x03ze\x06\xc2k\x84\x9e\x891"\xfa r\x87\xbbM\xb4\xe7}\xe6\x99',
                                                         date=datetime.datetime(1999, 5, 1, 22, 22, 16,tzinfo=datetime.timezone.utc),
                                                         mime_type='whatever_mime_type', size=47617434, dc_id=2,
